    ...
    <PageSection variant="default"
        ...
        <PageSectionContent>
            ...
            <ArticleInfoBlock image="images/logo/agency-logo.png"
                              :paragraphs="[
                                  `The <em>Foxy</em> template is a free Vue3 and Bootstrap5 theme. The downloadable files consist of the entire source code, including HTML, CSS, and Javascript. Please feel free to download and customize the theme as you wish.`,
...
/* Forzar que el enlace a GitHub dentro de este bloque use el color 2 de la paleta */
::v-deep .foxy-info-block-article .text-4 a[href*="github"] {
